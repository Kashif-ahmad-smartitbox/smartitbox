    ...
    <>
      ...
      <div className="absolute left-0 right-0 top-0 z-10">
        <div className="h-1 w-full overflow-hidden bg-gradient-to-r from-red-100 via-red-300 to-red-100">
          <div className="h-full w-full relative overflow-hidden">
            <div
              className="h-full w-1/4 bg-gradient-to-r from-transparent via-red-500 to-transparent animate-[shimmer_1.5s_ease-in-out_infinite]"
              style={{
                background:
      ...
      >
        ...
        <div className="relative">
          <svg
            className={`${spinner} animate-spin text-red-600`}
            viewBox="0 0 24 24"
            fill="none"
            aria-hidden="true"
          >
